...
const MULTI_FIELDS = [
  ...
  { key: "risk", label: "Risk Level", labelMap: { OPTIMAL: "Optimal", MONITOR: "Monitor", HIGH_COST: "High Cost", REVIEW: "Review", ACCEPTABLE: "Acceptable" } },
...
export function initFilters(onChange) {
  ...
  const optionsCache = {
    ...
    source: uniq(products.map((p) => p.source).filter((v) => v && v !== "-")),
  };
  ...
  applyFilters(); // re-apply now that the real price ceiling is known (fixes first-render clip)
